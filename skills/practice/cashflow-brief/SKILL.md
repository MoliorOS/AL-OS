...
fixes: F21 (monthly board pack manual assembly), the Connectivity Matrix's 4-hop cashflow question (context/stack.md)
---

Not yet built. Blocked on `context/finance.md`'s largest open item — Jon's spreadsheet logic
